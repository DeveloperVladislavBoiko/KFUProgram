...
int main() {
    ...
    // add_to_tree(t, 5.0, "Иван", "Иванов");
    // add_to_tree(t, 3.0, "Петр", "Петров");
    // add_to_tree(t, 7.0, "Сидор", "Сидоров");
    // add_to_tree(t, 2.0, "Анна", "Смирнова");
    // add_to_tree(t, 4.0, "Мария", "Кузнецова");
    // add_to_tree(t, 6.0, "Алексей", "Попов");
    // add_to_tree(t, 8.0, "Ольга", "Васильева");    
	double porog;
